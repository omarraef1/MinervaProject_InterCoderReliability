...
def main():
    ...
    coder_1 = pd.read_csv('output_ORG_iter2.csv', encoding='utf-8')
    ...
    coder_2 = pd.read_csv('output_AK_iter2.csv', encoding='utf-8')
    #cols = ['Sources', 'Actions', 'Targets', 'Districts', 'Provinces']
    cols_Src = ['Sources']
    coder_2_Src = coder_2
    ...
    coder_3 = pd.read_csv('output_AAB_iter2.csv', encoding='utf-8')
    #cols = ['Sources', 'Actions', 'Targets', 'Districts', 'Provinces']
    cols_Src = ['Sources']
    coder_3_Src = coder_3
     ...
     #   if(percCount==0):
      ...
      #  dataPandas.append({"file_name": article, "sources_c1&c2": srcPrcntg12, "sources_c1&c3": srcPrcntg13, "sources_c2&c3": srcPrcntg23,
       #                    "actions_c1&c2": actPrcntg12, "actions_c1&c3": actPrcntg13, "actions_c2&c3": actPrcntg23,
        ...
        df.to_csv('cosineSimilarities_iter2.csv', encoding = 'utf-8')
